class Dashboard::ImagesController < ApplicationController
  ...
  def create
    ActiveRecord::Base.transaction do
      ...
      redirect_to dashboard_club_album_path id: @album.id
    end
  rescue
  ...
  def destroy
    ...
    redirect_to dashboard_club_album_path id: @album.id, club_id: @album.club_id
  end
  ...
  def load_image
    ...
    unless @image
      ...
      redirect_to dashboard_club_album_path @album
    end
  end
