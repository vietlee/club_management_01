class Dashboard::NewsController < BaseDashboardController
  ...
  def create
    ...
    redirect_to dashboard_club_event_path id: params[:event_id]
  end
  ...
  def load_news
    ...
    unless @news
      ...
      redirect_to dashboard_club_event_path @event.club_id, @event
    end
  end
