! function(t, e) {
  ...
  function i(t, e) {
    if (!(t instanceof e)) throw new TypeError(I18n.t("cant_call_class_function"))
  }
  ...
  var M = function() {
      ...
      return function(e, o) {
        ...
        throw new TypeError(I18n.t("invalid_attempt_des_non_interable_instance"))
      }
    }(),
    w = function() {
      function t(t, e) {
  ...
  if ("undefined" == typeof C) throw new Error(I18n.t("require_utils_before_tether"));
  var P = C.Utils,
